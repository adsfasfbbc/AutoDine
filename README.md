...
Quick start (Python 3.10+): `make install`, `make seed DATABASE_URL=sqlite+pysqlite:///autodine.db`, and `make smoke`. For the full local stack, run `docker compose -f deploy/docker-compose.yml up --build`.
